...
//
// fishhook.c — dynamically rebinds symbols in Mach-O binaries running on iOS
...
static void _rebind_symbols_for_image(const struct mach_header *header,
                                       intptr_t slide) {
    rebind_symbols_for_image(_rebindings_head, (const mach_header_t *)header,
                              slide);
}
...
int rebind_symbols_image(void *header, intptr_t slide,
    ...
    rebind_symbols_for_image(rebindings_head, (const mach_header_t *)header,
                              slide);
    if (rebindings_head) {
